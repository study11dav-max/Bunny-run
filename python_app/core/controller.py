...
class AndroidController:
    ...
    def swipe_to_close(self):
        ...
        # Kernel-level Force Stop to ensure ad buffer flush
        os.system(f"am force-stop {self.package_name}")
        time.sleep(1.0)
        
        # Fallback to gestured clearing if force-stop is restricted
        os.system("input keyevent 187") # Open Recents
        time.sleep(1.0)
    ...
    def relaunch_game(self):
        ...
        # Professional clean launch via monkey
        os.system(f"monkey -p {self.package_name} 1")
